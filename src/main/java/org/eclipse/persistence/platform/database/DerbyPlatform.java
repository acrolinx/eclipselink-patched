...
/**
 * <p>
 * <b>Purpose</b>: Provides Derby DBMS specific behavior.
 *
 * PATCHED: {@link #initializeConnectionData(Connection)} to set {@link #isSequenceSupported} to
 * false. Otherwise we will break compatibility with older reporting databases. Added
 * {@link #getMaxForeignKeyNameSize()} to increase length of fk-names to 36
 *
...
public class DerbyPlatform extends DB2Platform
{
    ...
    private static final long serialVersionUID = -4080803055108549645L;
    ...
    {
        // PATCHED, increased value because we had same name for different foreign keys.
        // http://db.apache.org/derby/docs/10.0/manuals/reference/sqlj160.html says that 36
        // chararcters are valid.
        return 36;
    }
     ...
     */
    @Override
    protected void appendByteArray(final byte[] bytes, final Writer writer) throws IOException
    {
     ...
     */
    @Override
    public void printSQLSelectStatement(final DatabaseCall call, final ExpressionSQLPrinter printer,
                                        final SQLSelectStatement statement)
    {
