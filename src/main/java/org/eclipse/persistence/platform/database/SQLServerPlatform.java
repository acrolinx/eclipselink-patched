...
public class SQLServerPlatform extends org.eclipse.persistence.platform.database.DatabasePlatform {
    ...
    */
    ...
    protected Hashtable buildFieldTypes() {
        ...
        // PATCHED to make EclipseLink create an unicode compatible schema
        ...
        // PATCHED to make EclipseLink create an unicode compatible schema
        fieldTypeMapping.put(Character[].class, new FieldTypeDefinition("NTEXT", false));
        fieldTypeMapping.put(byte[].class, new FieldTypeDefinition("IMAGE", false));
        // PATCHED to make EclipseLink create an unicode compatible schema
        fieldTypeMapping.put(char[].class, new FieldTypeDefinition("NTEXT", false));
        fieldTypeMapping.put(java.sql.Blob.class, new FieldTypeDefinition("IMAGE", false));
        // PATCHED to make EclipseLink create an unicode compatible schema
        fieldTypeMapping.put(java.sql.Clob.class, new FieldTypeDefinition("NTEXT", false));
